...
{
    public class BasicAstronomicalObjectViewModel : BaseViewModel 
    {
        private readonly BasicAstronomicalObject _astronomicalObject;
        ...
        public BasicAstronomicalObjectViewModel(AstronomicalObject astronomicalObject)
        {
